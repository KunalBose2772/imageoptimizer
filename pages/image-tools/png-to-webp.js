...
const PngToWebpPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/png-to-webp', {
          method: 'POST',
          body: formData,
        });
  ...
  return (
    <Layout 
      title="Convert PNG to WEBP Online for Free"
      description="Convert PNG images to WEBP format instantly. Superior compression with customizable quality settings. Free, fast, and secure."
      keywords="PNG to WEBP, convert PNG, PNG converter, image converter, free converter"
    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your PNG images to modern WEBP format instantly. 
                    Superior compression with customizable quality settings. 
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our PNG to WEBP Converter?</h2>
                <p className="text-large">
                  Experience the best PNG to WEBP conversion with our advanced features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert your PNG files to WEBP in seconds with our optimized processing engine.
                  </p>
                </div>
                ...
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <h3 className="heading-4 mb-4 group-hover:text-primary-500 transition-colors duration-300">Massive Size Reduction</h3>
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Reduce PNG file sizes by up to 80% while maintaining excellent quality.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting PNG to WEBP</h2>
              
              <p className="text-body mb-6">
                PNG is a lossless format that preserves perfect quality but creates large file sizes. 
                WEBP offers excellent compression with customizable quality settings, making it ideal 
                for web images where file size optimization is crucial for faster loading times.
              </p>
              ...
              <p className="text-body mb-6">
                ...
                without quality loss. It supports transparency and is excellent for graphics, logos, and images 
                with sharp edges. However, PNG files are typically much larger than WEBP files.
              </p>

              <h3 className="heading-3 mb-4">Why Convert PNG to WEBP?</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Massive Size Reduction:</strong> WEBP can reduce PNG file sizes by up to 80%</li>
                <li><strong>Web Optimization:</strong> Faster loading times for websites and applications</li>
                <li><strong>Quality Control:</strong> Customizable compression settings</li>
                <li><strong>Modern Standard:</strong> Supported by all modern browsers</li>
              </ul>

              <h3 className="heading-3 mb-4">How Our PNG to WEBP Converter Works</h3>
              <p className="text-body mb-6">
                Our converter uses advanced Sharp and Pillow libraries to ensure high-quality conversion. 
                The process involves decoding the PNG file, applying quality optimization, and encoding 
                to WEBP format while preserving maximum visual fidelity. You can convert single files or 
                batch process up to 20 PNG files simultaneously for maximum efficiency.
              </p>
              ...
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>80-100%:</strong> Highest quality, larger file size</li>
                <li><strong>60-79%:</strong> Good balance of quality and size</li>
                <li><strong>40-59%:</strong> Moderate compression, smaller files</li>
                <li><strong>10-39%:</strong> High compression, smallest files</li>
              </ul>

              <h3 className="heading-3 mb-4">Best Practices</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li>Use 80-90% quality for professional images</li>
                <li>Use 60-70% quality for web images</li>
                <li>Use 40-50% quality for thumbnails and previews</li>
                <li>Always keep original PNG files as backup</li>
              </ul>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is PNG to WEBP conversion free?</h3>
                  <p className="text-body">
                    Yes, our PNG to WEBP converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most PNG to WEBP conversions complete in under 3 seconds. Processing time 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    For most purposes, we recommend 70-80% quality, which provides excellent 
                    visual quality with significant file size reduction. Adjust based on your specific needs.
                  </p>
                </div>
