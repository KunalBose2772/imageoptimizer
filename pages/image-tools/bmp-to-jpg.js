...
const BmpToJpgPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/bmp-to-jpg', {
          method: 'POST',
          body: formData,
        });
        ...
        const filename = file.name.replace(/\.bmp$/i, '.jpg');
  ...
  return (
    <Layout 
      title="Convert BMP to JPG Online for Free"
      description="Convert BMP images to JPG format instantly. Massive file size reduction with customizable quality settings. Free, fast, and secure."
      keywords="BMP to JPG, convert BMP, BMP converter, image converter, free converter"
    >
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-16 page-theme-slate">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  <div className="inline-flex items-center space-x-2 bg-slate-100 dark:bg-slate-900/30 text-slate-700 dark:text-slate-300 px-4 py-2 rounded-full text-sm font-medium mb-6">
                  ...
                  <p className="text-large mb-8">
                    Transform your BMP images to JPG format instantly. 
                    Massive file size reduction with customizable quality settings. 
                ...
                <div className="glass-morphism-box no-shine rounded-3xl p-8">
                  ...
                  <div className="mt-6">
                    <button
                      ...
                      className="convert-button-slate w-full py-3 px-6 rounded-xl font-semibold disabled:cursor-not-allowed flex items-center justify-center space-x-2 hover:opacity-90 transition-opacity"
                    >
                      {isConverting ? (
                        <>
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our BMP to JPG Converter?</h2>
                <p className="text-large">
                  Experience the best BMP to JPG conversion with our advanced features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert your BMP files to JPG in seconds with our optimized processing engine.
                  </p>
                </div>
                ...
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Reduce BMP file sizes by up to 95% while maintaining excellent visual quality.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting BMP to JPG</h2>
              
              <p className="text-body mb-6">
                BMP (Bitmap) is an uncompressed image format that creates very large file sizes. 
                Converting BMP to JPG can reduce file sizes by up to 95% while maintaining excellent 
                visual quality, making it perfect for web use, email attachments, and storage optimization.
              </p>
              ...
              <h3 className="heading-3 mb-4">Why Convert BMP to JPG?</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Massive Size Reduction:</strong> JPG can reduce BMP file sizes by up to 95%</li>
                <li><strong>Web Optimization:</strong> Much faster loading times for websites and applications</li>
                <li><strong>Universal Compatibility:</strong> JPG is supported by all devices and platforms</li>
                <li><strong>Storage Efficiency:</strong> Save significant disk space and bandwidth</li>
              </ul>

              <h3 className="heading-3 mb-4">How Our BMP to JPG Converter Works</h3>
              <p className="text-body mb-6">
                Our converter uses advanced Sharp and Pillow libraries to ensure high-quality conversion. 
                The process involves decoding the BMP file, applying quality optimization, and encoding 
              ...
              <ul className="list-disc pl-6 mb-6 text-body">
                ...
                <li>Always keep original BMP files as backup</li>
              </ul>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is BMP to JPG conversion free?</h3>
                  <p className="text-body">
                    Yes, our BMP to JPG converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most BMP to JPG conversions complete in under 3 seconds. Processing time 
