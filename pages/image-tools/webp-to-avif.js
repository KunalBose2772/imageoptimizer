...
const WebpToAvifPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/webp-to-avif', {
          method: 'POST',
          body: formData,
        });
        ...
        const filename = file.name.replace(/\.webp$/i, '.avif');
  ...
  return (
    <Layout 
      title="Convert WEBP to AVIF Online for Free"
      description="Convert WEBP images to AVIF format instantly. High-quality conversion with customizable quality settings. Free, fast, and secure."
      keywords="WEBP to AVIF, convert WEBP, WEBP converter, image converter, free converter"
    >
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-16 page-theme-cyan">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your WEBP images to next-generation AVIF format instantly. 
                ...
                <div className="glass-morphism-box no-shine rounded-3xl p-8">
                  ...
                  <div className="mt-6">
                    <button
                      ...
                      className="convert-button-cyan w-full py-3 px-6 rounded-xl font-semibold disabled:cursor-not-allowed flex items-center justify-center space-x-2 hover:opacity-90 transition-opacity"
                    >
                      {isConverting ? (
                        <>
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our WEBP to AVIF Converter?</h2>
                <p className="text-large">
                  Experience the best WEBP to AVIF conversion with our advanced features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert your WEBP files to AVIF in seconds with our optimized processing engine.
                  </p>
                </div>
                ...
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <h3 className="heading-4 mb-4 group-hover:text-primary-500 transition-colors duration-300">Next-Gen Quality</h3>
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Get superior compression and quality with the latest AVIF format technology.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting WEBP to AVIF</h2>
              ...
              <p className="text-body mb-6">
                WEBP is Google's modern image format that provides excellent compression efficiency. 
                It can reduce file sizes by up to 35% compared to JPEG while maintaining similar visual quality. 
                However, AVIF offers even better compression, making it the next evolution in image formats.
              </p>

              <h3 className="heading-3 mb-4">Why Convert WEBP to AVIF?</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Superior Compression:</strong> AVIF offers 50% better compression than WEBP</li>
                <li><strong>Future-Proof:</strong> AVIF is the next-generation image format</li>
                <li><strong>Better Quality:</strong> Maintains higher quality at smaller file sizes</li>
                <li><strong>Wide Browser Support:</strong> Growing support across modern browsers</li>
              </ul>

              <h3 className="heading-3 mb-4">How Our WEBP to AVIF Converter Works</h3>
              <p className="text-body mb-6">
                Our converter uses advanced Sharp and Pillow libraries to ensure high-quality conversion. 
                The process involves decoding the WEBP file, applying quality optimization, and encoding 
                to AVIF format while preserving maximum visual fidelity. You can convert single files or 
                batch process up to 20 WEBP files simultaneously for maximum efficiency.
              </p>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is WEBP to AVIF conversion free?</h3>
                  <p className="text-body">
                    Yes, our WEBP to AVIF converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most WEBP to AVIF conversions complete in under 3 seconds. Processing time 
