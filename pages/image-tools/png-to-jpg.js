...
const PngToJpgPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/png-to-jpg', {
          method: 'POST',
          body: formData,
        });
  ...
  return (
    <Layout 
      ...
      description="Convert PNG images to JPG format instantly. High-quality conversion with customizable quality settings. Free, fast, and secure."
      keywords="PNG to JPG, convert PNG, PNG converter, image converter, free converter"
    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your PNG images to JPG format instantly. 
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our PNG to JPG Converter?</h2>
                <p className="text-large">
                  Experience the best PNG to JPG conversion with our advanced features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert your PNG files to JPG in seconds with our optimized processing engine.
                  </p>
                </div>
                ...
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <h3 className="heading-4 mb-4 group-hover:text-primary-500 transition-colors duration-300">Quality Control</h3>
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Customize compression quality from 10% to 100% for perfect balance of size and quality.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting PNG to JPG</h2>
              
              <p className="text-body mb-6">
                PNG is a lossless image format that preserves perfect quality but creates larger file sizes. 
                JPG offers excellent compression with customizable quality settings, making it ideal for 
                web images, photography, and sharing where file size matters.
              </p>
              ...
              <p className="text-body mb-6">
                ...
                with sharp edges. However, PNG files are typically much larger than JPG files.
              </p>

              <h3 className="heading-3 mb-4">Why Convert PNG to JPG?</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Smaller File Sizes:</strong> JPG compression can reduce file sizes by 70-90%</li>
                ...
                <li><strong>Photography Ready:</strong> Ideal format for photos and complex images</li>
              </ul>

              <h3 className="heading-3 mb-4">How Our PNG to JPG Converter Works</h3>
              <p className="text-body mb-6">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is PNG to JPG conversion free?</h3>
                  <p className="text-body">
                    Yes, our PNG to JPG converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most PNG to JPG conversions complete in under 3 seconds. Processing time 
