...
const SvgToJpgPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/svg-to-jpg', {
          method: 'POST',
          body: formData,
        });
        ...
        const filename = file.name.replace(/\.(svg)$/i, '.jpg');
  ...
  return (
    <Layout 
      title="Convert SVG to JPG Online for Free"
      description="Convert SVG files to JPG format instantly. High-quality conversion with customizable quality settings. Free, fast, and secure."
      keywords="SVG to JPG, convert SVG, SVG converter, image converter, free converter"
    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your SVG files to universal JPG format instantly. 
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our SVG to JPG Converter?</h2>
                <p className="text-large">
                  Experience the best SVG to JPG conversion with our advanced features.
                </p>
              </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting SVG to JPG</h2>
              ...
              <h3 className="heading-3 mb-4">Why Convert SVG to JPG?</h3>
              ...
              <h3 className="heading-3 mb-4">How Our SVG to JPG Converter Works</h3>
              <p className="text-body mb-6">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is SVG to JPG conversion free?</h3>
                  <p className="text-body">
                    Yes, our SVG to JPG converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most SVG to JPG conversions complete in under 3 seconds. Processing time 
