...
const AvifToWebpPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/avif-to-webp', {
          method: 'POST',
          headers: {
        ...
        const filename = file.name.replace(/\.(avif|heif)$/i, '.webp');
  ...
  return (
    <Layout 
      title="Convert AVIF to WEBP Online for Free"
      description="Convert AVIF images to WEBP format instantly. High-quality conversion with superior compression. Free, fast, and secure."
      keywords="AVIF to WEBP, convert AVIF, AVIF converter, image converter, free converter"
    >
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-16 page-theme-red">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your AVIF images to modern WEBP format instantly. 
                    High-quality conversion with superior compression. 
                ...
                <div className="glass-morphism-box no-shine rounded-3xl p-8">
                  ...
                  <div className="mt-6">
                    <button
                      ...
                      className="convert-button-red w-full py-3 px-6 rounded-xl font-semibold disabled:cursor-not-allowed flex items-center justify-center space-x-2 hover:opacity-90 transition-opacity"
                    >
                      {isConverting ? (
                        <>
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our AVIF to WEBP Converter?</h2>
                <p className="text-large">
                  Experience the best AVIF to WEBP conversion with our advanced features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert your AVIF files to WEBP in seconds with our optimized processing engine.
                  </p>
                </div>
                ...
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Get up to 35% smaller file sizes with WEBP's advanced compression algorithms.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting AVIF to WEBP</h2>
              ...
              <p className="text-body mb-6">
                ...
                support AVIF files, making WEBP conversion essential for broader compatibility.
              </p>
              ...
              <p className="text-body mb-6">
                ...
                However, browser support for AVIF is still limited, making WEBP conversion necessary for 
                universal compatibility.
              </p>

              <h3 className="heading-3 mb-4">Why Convert AVIF to WEBP?</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Universal Compatibility:</strong> WEBP is supported by all modern browsers and devices</li>
                <li><strong>Superior Compression:</strong> Up to 35% smaller than JPEG with better quality</li>
                <li><strong>Transparency Support:</strong> Maintains alpha channels and transparency</li>
                <li><strong>Web Optimized:</strong> Perfect for web performance and SEO</li>
              </ul>

              <h3 className="heading-3 mb-4">How Our AVIF to WEBP Converter Works</h3>
              <p className="text-body mb-6">
                Our converter uses advanced Sharp and Pillow libraries to ensure high-quality conversion. 
                The process involves decoding the AVIF file, applying WEBP compression, and encoding 
              ...
              <h3 className="heading-3 mb-4">WEBP vs Other Formats</h3>
              <p className="text-body mb-6">
                WEBP offers several advantages over other formats:
              </p>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Better Compression:</strong> 25-35% smaller than JPEG with same quality</li>
                <li><strong>Transparency Support:</strong> Perfect for logos and graphics with transparent backgrounds</li>
                <li><strong>Animation Support:</strong> Can store animated images like GIF</li>
                <li><strong>Web Performance:</strong> Faster loading times and better SEO</li>
              </ul>

              <h3 className="heading-3 mb-4">Best Practices</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li>Use WEBP for web images and social media</li>
                <li>Use WEBP for images that need both quality and small file size</li>
                <li>Use WEBP for images with transparency</li>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is AVIF to WEBP conversion free?</h3>
                  <p className="text-body">
                    Yes, our AVIF to WEBP converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most AVIF to WEBP conversions complete in under 3 seconds. Processing time 
                ...
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Does WEBP support transparency?</h3>
                  <p className="text-body">
                    Yes! WEBP format supports full alpha channel transparency, making it perfect 
