...
const BmpToWebpPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/bmp-to-webp', {
          method: 'POST',
          body: formData,
        });
        ...
        const filename = file.name.replace(/\.bmp$/i, '.webp');
  ...
  return (
    <Layout 
      title="Convert BMP to WEBP Online for Free"
      description="Convert BMP images to WEBP format instantly. Massive file size reduction with customizable quality settings. Free, fast, and secure."
      keywords="BMP to WEBP, convert BMP, BMP converter, image converter, free converter"
    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <h1 className="heading-1 mb-6">
                    Convert BMP to WEBP Online for Free
                  </h1>
                  
                  <p className="text-large mb-8">
                    Transform your BMP images to WEBP format instantly. 
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our BMP to WEBP Converter?</h2>
                <p className="text-large">
                  Experience the best BMP to WEBP conversion with our advanced features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert your BMP files to WEBP in seconds with our optimized processing engine.
                  </p>
                </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting BMP to WEBP</h2>
              
              <p className="text-body mb-6">
                BMP (Bitmap) is an uncompressed image format that creates very large file sizes. 
                Converting BMP to WEBP can reduce file sizes by up to 95% while maintaining excellent 
                visual quality, making it perfect for modern web applications and mobile devices.
              </p>
              ...
              <h3 className="heading-3 mb-4">Why Convert BMP to WEBP?</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Massive Size Reduction:</strong> WEBP can reduce BMP file sizes by up to 95%</li>
                <li><strong>Superior Compression:</strong> Better compression than JPEG and PNG</li>
              ...
              <h3 className="heading-3 mb-4">How Our BMP to WEBP Converter Works</h3>
              <p className="text-body mb-6">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is BMP to WEBP conversion free?</h3>
                  <p className="text-body">
                    Yes, our BMP to WEBP converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most BMP to WEBP conversions complete in under 3 seconds. Processing time 
