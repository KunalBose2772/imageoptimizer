...
const PsdToPngPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/psd-to-png', {
          method: 'POST',
          body: formData,
        });
  ...
  return (
    <Layout 
      title="Convert PSD to PNG Online for Free"
      description="Convert PSD files to PNG format instantly. Lossless conversion with transparency support. Free, fast, and secure."
      keywords="PSD to PNG, convert PSD, PSD converter, image converter, free converter"
    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your PSD files to universal PNG format instantly. 
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our PSD to PNG Converter?</h2>
                <p className="text-large">
                  Experience the best PSD to PNG conversion with our advanced features.
                </p>
              </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting PSD to PNG</h2>
              ...
              <h3 className="heading-3 mb-4">Why Convert PSD to PNG?</h3>
              ...
              <h3 className="heading-3 mb-4">How Our PSD to PNG Converter Works</h3>
              <p className="text-body mb-6">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is PSD to PNG conversion free?</h3>
                  <p className="text-body">
                    Yes, our PSD to PNG converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most PSD to PNG conversions complete in under 3 seconds. Processing time 
