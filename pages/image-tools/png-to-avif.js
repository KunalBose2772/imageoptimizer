...
const PngToAvifPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/png-to-avif', {
          method: 'POST',
          headers: {
  ...
  return (
    <Layout 
      title="Convert PNG to AVIF Online for Free"
      description="Convert PNG images to AVIF format instantly. Superior compression with transparency support. Free, fast, and secure."
      keywords="PNG to AVIF, convert PNG, PNG converter, image converter, free converter"
    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your PNG images to modern AVIF format instantly. 
                    Superior compression with transparency support and up to 50% smaller file sizes. 
                ...
                <div className="glass-morphism-box no-shine rounded-3xl p-8">
                  <div className="text-center mb-6">
                    <h2 className="heading-3 mb-2">Upload Your PNG Files</h2>
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our PNG to AVIF Converter?</h2>
                <p className="text-large">
                  Experience the best PNG to AVIF conversion with our advanced features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert your PNG files to AVIF in seconds with our optimized processing engine.
                  </p>
                </div>
                ...
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert up to 20 PNG files simultaneously with our batch processing feature.
                  </p>
                </div>
                ...
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <h3 className="heading-4 mb-4 group-hover:text-primary-500 transition-colors duration-300">Transparency Support</h3>
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Maintain perfect transparency and alpha channels with AVIF's advanced compression.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting PNG to AVIF</h2>
              
              <p className="text-body mb-6">
                PNG is a popular lossless image format known for its transparency support, but AVIF offers 
                superior compression while maintaining transparency. Converting PNG to AVIF can reduce file 
                sizes by up to 50% while preserving all visual quality and transparency features.
              </p>
              ...
              <p className="text-body mb-6">
                ...
                It provides exceptional compression efficiency, reducing file sizes by up to 50% compared 
                to PNG while maintaining similar or better visual quality. AVIF supports both lossy and 
                lossless compression, making it perfect for graphics with transparency.
              </p>

              <h3 className="heading-3 mb-4">Why Convert PNG to AVIF?</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Superior Compression:</strong> Up to 50% smaller files than PNG with better quality</li>
                <li><strong>Transparency Support:</strong> Full alpha channel support like PNG</li>
                <li><strong>Modern Format:</strong> Future-proof format with growing browser support</li>
                <li><strong>Web Performance:</strong> Faster loading times and better SEO</li>
              </ul>

              <h3 className="heading-3 mb-4">How Our PNG to AVIF Converter Works</h3>
              <p className="text-body mb-6">
                Our converter uses advanced Sharp and Pillow libraries to ensure high-quality conversion. 
                The process involves decoding the PNG file, preserving transparency, applying AVIF compression 
                with optimal settings, and encoding to AVIF format while maintaining maximum visual fidelity. 
                You can convert single files or batch process up to 20 PNG files simultaneously for maximum efficiency.
              </p>

              <h3 className="heading-3 mb-4">AVIF vs PNG Comparison</h3>
              <p className="text-body mb-6">
                AVIF offers several advantages over PNG:
              </p>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Better Compression:</strong> 50% smaller files than PNG with similar quality</li>
                <li><strong>Transparency Support:</strong> Full alpha channel support like PNG</li>
                <li><strong>Better Quality:</strong> Advanced algorithms preserve more image detail</li>
                <li><strong>Future-Proof:</strong> Growing browser support and industry adoption</li>
              </ul>

              <h3 className="heading-3 mb-4">Best Practices</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li>Use AVIF for web graphics with transparency</li>
                <li>Use AVIF for logos, icons, and UI elements</li>
                <li>Consider fallback formats for older browsers</li>
                <li>Test AVIF compatibility with your target audience</li>
              </ul>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is PNG to AVIF conversion free?</h3>
                  <p className="text-body">
                    Yes, our PNG to AVIF converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    You can convert PNG files up to 50MB in size. For larger files, consider 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most PNG to AVIF conversions complete in under 3 seconds. Processing time 
                ...
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Does AVIF preserve transparency?</h3>
                  <p className="text-body">
                    Yes! AVIF format supports full alpha channel transparency, making it perfect 
                    for logos, graphics, and images that need transparent backgrounds, just like PNG.
                  </p>
                </div>
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Yes! Our converter supports batch processing of up to 20 PNG files simultaneously. 
