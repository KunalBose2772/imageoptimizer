...
const IcoToAvifPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/ico-to-avif', {
          method: 'POST',
          body: formData,
        });
        ...
        const filename = file.name.replace(/\.(ico)$/i, '.avif');
  ...
  return (
    <Layout 
      title="Convert ICO to AVIF Online for Free"
      description="Convert ICO files to AVIF format instantly. High-quality conversion with customizable quality settings. Free, fast, and secure."
      keywords="ICO to AVIF, convert ICO, ICO converter, image converter, free converter"
    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your ICO files to next-generation AVIF format instantly. 
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our ICO to AVIF Converter?</h2>
                <p className="text-large">
                  Experience the best ICO to AVIF conversion with our advanced features.
                </p>
              </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting ICO to AVIF</h2>
              ...
              <p className="text-body mb-6">
                ...
                making AVIF conversion essential for broader compatibility and better quality.
              </p>
              ...
              <p className="text-body mb-6">
                ...
                browser support and are not ideal for modern web use, making AVIF conversion necessary for universal compatibility.
              </p>

              <h3 className="heading-3 mb-4">Why Convert ICO to AVIF?</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Next-Gen Format:</strong> AVIF is the future of web images with superior compression</li>
                <li><strong>Best Compression:</strong> 50% smaller file sizes than JPG, 20% smaller than WebP</li>
                <li><strong>Transparency Support:</strong> Full alpha channel support like PNG</li>
                <li><strong>Modern Browser Support:</strong> Supported by Chrome, Firefox, and Safari</li>
              </ul>

              <h3 className="heading-3 mb-4">How Our ICO to AVIF Converter Works</h3>
              <p className="text-body mb-6">
                Our converter uses advanced Sharp library to ensure high-quality conversion. 
                The process involves decoding the ICO file and encoding to AVIF format while preserving 
              ...
              <h3 className="heading-3 mb-4">AVIF Quality Settings Explained</h3>
              <p className="text-body mb-6">
              ...
              <h3 className="heading-3 mb-4">Best Practices for AVIF</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                ...
                <li>AVIF offers the best compression of all modern formats</li>
              </ul>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is ICO to AVIF conversion free?</h3>
                  <p className="text-body">
                    Yes, our ICO to AVIF converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most ICO to AVIF conversions complete in under 3 seconds. Processing time 
