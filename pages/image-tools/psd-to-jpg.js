...
const PsdToJpgPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/psd-to-jpg', {
          method: 'POST',
          body: formData,
        });
        ...
        const filename = file.name.replace(/\.(psd)$/i, '.jpg');
  ...
  return (
    <Layout 
      title="Convert PSD to JPG Online for Free"
      description="Convert PSD files to JPG format instantly. High-quality conversion with customizable quality settings. Free, fast, and secure."
      keywords="PSD to JPG, convert PSD, PSD converter, image converter, free converter"
    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your PSD files to universal JPG format instantly. 
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our PSD to JPG Converter?</h2>
                <p className="text-large">
                  Experience the best PSD to JPG conversion with our advanced features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert your PSD files to JPG in seconds with our optimized processing engine.
                  </p>
                </div>
                ...
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert up to 20 PSD files simultaneously with our batch processing feature.
                  </p>
                </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting PSD to JPG</h2>
              
              <p className="text-body mb-6">
                PSD (AV1 Image File Format) is a modern image format that offers superior compression 
                compared to traditional formats like JPG and PNG. However, not all devices and applications 
                support PSD files, making JPG conversion essential for broader compatibility.
              </p>

              <h3 className="heading-3 mb-4">What is PSD Format?</h3>
              <p className="text-body mb-6">
                PSD is based on the AV1 video codec and provides excellent compression efficiency. 
                It can reduce file sizes by up to 50% compared to JPEG while maintaining similar visual quality. 
                However, browser support for PSD is still limited, making JPG conversion necessary for 
                universal compatibility.
              </p>

              <h3 className="heading-3 mb-4">Why Convert PSD to JPG?</h3>
              ...
              <h3 className="heading-3 mb-4">How Our PSD to JPG Converter Works</h3>
              <p className="text-body mb-6">
                Our converter uses advanced Sharp and Pillow libraries to ensure high-quality conversion. 
                The process involves decoding the PSD file, applying quality optimization, and encoding 
                to JPG format while preserving maximum visual fidelity. You can convert single files or 
                batch process up to 20 PSD files simultaneously for maximum efficiency.
              </p>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is PSD to JPG conversion free?</h3>
                  <p className="text-body">
                    Yes, our PSD to JPG converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most PSD to JPG conversions complete in under 3 seconds. Processing time 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Yes! Our converter supports batch processing of up to 20 PSD files simultaneously. 
