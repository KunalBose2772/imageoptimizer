...
const WebpToJpgPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/webp-to-jpg', {
          method: 'POST',
          body: formData,
        });
  ...
  return (
    <Layout 
      title="Convert WEBP to JPG Online for Free"
      description="Convert WEBP images to JPG format instantly. Universal compatibility with customizable quality settings. Free, fast, and secure."
      keywords="WEBP to JPG, convert WEBP, WEBP converter, image converter, free converter"
    >
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-16 page-theme-rose">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  <div className="inline-flex items-center space-x-2 bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-300 px-4 py-2 rounded-full text-sm font-medium mb-6">
                  ...
                  <p className="text-large mb-8">
                    Transform your WEBP images to universal JPG format instantly. 
                ...
                <div className="glass-morphism-box no-shine rounded-3xl p-8">
                  ...
                  <div className="mt-6">
                    <button
                      ...
                      className="convert-button-rose w-full py-3 px-6 rounded-xl font-semibold disabled:cursor-not-allowed flex items-center justify-center space-x-2 hover:opacity-90 transition-opacity"
                    >
                      {isConverting ? (
                        <>
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our WEBP to JPG Converter?</h2>
                <p className="text-large">
                  Experience the best WEBP to JPG conversion with our advanced features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert your WEBP files to JPG in seconds with our optimized processing engine.
                  </p>
                </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting WEBP to JPG</h2>
              
              <p className="text-body mb-6">
                WEBP is a modern image format that offers superior compression, but JPG remains the most 
                universally supported format. Converting WEBP to JPG ensures compatibility with older 
                devices, applications, and platforms that don't support the newer WEBP format.
              </p>
              ...
              <p className="text-body mb-6">
                ...
                However, not all devices and applications support WEBP, making JPG conversion necessary for universal compatibility.
              </p>

              <h3 className="heading-3 mb-4">Why Convert WEBP to JPG?</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                ...
                <li><strong>Legacy Support:</strong> Works with older software and systems</li>
              ...
              <h3 className="heading-3 mb-4">How Our WEBP to JPG Converter Works</h3>
              <p className="text-body mb-6">
              ...
              <ul className="list-disc pl-6 mb-6 text-body">
                ...
                <li>Always keep original WEBP files as backup</li>
              </ul>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is WEBP to JPG conversion free?</h3>
                  <p className="text-body">
                    Yes, our WEBP to JPG converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most WEBP to JPG conversions complete in under 3 seconds. Processing time 
