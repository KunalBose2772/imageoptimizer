...
const JpgToAvifPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/jpg-to-avif', {
          method: 'POST',
          headers: {
  ...
  return (
    <Layout 
      title="Convert JPG to AVIF Online for Free"
      description="Convert JPG images to AVIF format instantly. Superior compression with modern format support. Free, fast, and secure."
      keywords="JPG to AVIF, convert JPG, JPG converter, image converter, free converter"
    >
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-16 page-theme-orange">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your JPG images to modern AVIF format instantly. 
                    Superior compression with up to 50% smaller file sizes. 
                ...
                <div className="glass-morphism-box no-shine rounded-3xl p-8">
                  ...
                  <div className="mt-6">
                    <button
                      ...
                      className="convert-button-orange w-full py-3 px-6 rounded-xl font-semibold disabled:cursor-not-allowed flex items-center justify-center space-x-2 hover:opacity-90 transition-opacity"
                    >
                      {isConverting ? (
                        <>
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our JPG to AVIF Converter?</h2>
                <p className="text-large">
                  Experience the best JPG to AVIF conversion with our advanced features.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Convert your JPG files to AVIF in seconds with our optimized processing engine.
                  </p>
                </div>
                ...
                <div className="glass-morphism-box rounded-2xl p-8 text-center group">
                  ...
                  <h3 className="heading-4 mb-4 group-hover:text-primary-500 transition-colors duration-300">Superior Compression</h3>
                  <p className="text-body group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                    Get up to 50% smaller file sizes with AVIF's advanced compression algorithms.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting JPG to AVIF</h2>
              
              <p className="text-body mb-6">
                JPG (JPEG) is the most widely used image format, but AVIF offers superior compression 
                and quality. Converting JPG to AVIF can reduce file sizes by up to 50% while maintaining 
                excellent visual quality, making it perfect for modern web applications.
              </p>
              ...
              <p className="text-body mb-6">
                ...
                to JPEG while maintaining similar or better visual quality. AVIF supports both lossy and 
                lossless compression, making it versatile for various use cases.
              </p>

              <h3 className="heading-3 mb-4">Why Convert JPG to AVIF?</h3>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Superior Compression:</strong> Up to 50% smaller files than JPG with better quality</li>
              ...
              <h3 className="heading-3 mb-4">How Our JPG to AVIF Converter Works</h3>
              <p className="text-body mb-6">
                Our converter uses advanced Sharp and Pillow libraries to ensure high-quality conversion. 
                The process involves decoding the JPG file, applying AVIF compression with optimal settings, 
                and encoding to AVIF format while preserving maximum visual fidelity. You can convert single 
                files or batch process up to 20 JPG files simultaneously for maximum efficiency.
              </p>

              <h3 className="heading-3 mb-4">AVIF vs Other Formats</h3>
              <p className="text-body mb-6">
                AVIF offers several advantages over other formats:
              </p>
              <ul className="list-disc pl-6 mb-6 text-body">
                <li><strong>Better than JPEG:</strong> 50% smaller files with better quality</li>
                <li><strong>Better than WebP:</strong> 20% smaller than WebP with similar quality</li>
                <li><strong>Better than PNG:</strong> Much smaller than PNG for photos</li>
              ...
              <ul className="list-disc pl-6 mb-6 text-body">
                <li>Use AVIF for web images where file size matters</li>
                <li>Use AVIF for high-quality photos and graphics</li>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is JPG to AVIF conversion free?</h3>
                  <p className="text-body">
                    Yes, our JPG to AVIF converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most JPG to AVIF conversions complete in under 3 seconds. Processing time 
                ...
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Does AVIF support transparency?</h3>
                  <p className="text-body">
                    Yes! AVIF format supports full alpha channel transparency, making it perfect 
                    for logos, graphics, and images that need transparent backgrounds.
                  </p>
                </div>
