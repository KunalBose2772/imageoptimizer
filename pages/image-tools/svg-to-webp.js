...
const SvgToWebpPage = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      if (conversionMode === 'single' || selectedFiles.length === 1) {
        ...
        const response = await fetch('/api/image/svg-to-webp', {
          method: 'POST',
          body: formData,
        });
        ...
        const filename = file.name.replace(/\.(svg)$/i, '.webp');
  ...
  return (
    <Layout 
      title="Convert SVG to WebP Online for Free"
      description="Convert SVG files to WebP format instantly. High-quality conversion with customizable quality settings. Free, fast, and secure."
      keywords="SVG to WebP, convert SVG, SVG converter, image converter, free converter"
    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-large mb-8">
                    Transform your SVG files to modern WebP format instantly. 
          ...
          <div className="container-custom">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="heading-2 mb-4">Why Choose Our SVG to WebP Converter?</h2>
                <p className="text-large">
                  Experience the best SVG to WebP conversion with our advanced features.
                </p>
              </div>
        ...
        <section className="section-padding bg-gray-50 dark:bg-gray-900">
          <div className="container-custom">
            <div className="max-w-7xl mx-auto prose prose-lg dark:prose-invert">
              <h2 className="heading-2 mb-6">Complete Guide to Converting SVG to WebP</h2>
              ...
              <h3 className="heading-3 mb-4">Why Convert SVG to WebP?</h3>
              ...
              <h3 className="heading-3 mb-4">How Our SVG to WebP Converter Works</h3>
              <p className="text-body mb-6">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="card p-6">
                  <h3 className="heading-4 mb-3">Is SVG to WebP conversion free?</h3>
                  <p className="text-body">
                    Yes, our SVG to WebP converter is completely free to use with no hidden costs, 
                ...
                <div className="card p-6">
                  ...
                  <p className="text-body">
                    Most SVG to WebP conversions complete in under 3 seconds. Processing time 
