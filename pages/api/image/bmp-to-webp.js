  ...
  try {
    ...
    const form = formidable({
      ...
      filter: ({ mimetype }) => {
        ...
        return mimetype && (mimetype.includes('image/bmp') || mimetype.includes('image/x-ms-bmp'));
      },
    });
    ...
    // Convert BMP to WEBP using Sharp
    await sharp(uploadedFile.filepath)
      .webp({ 
        quality: quality,
        effort: 6 // Balance between compression speed and file size
      })
      .toFile(outputPath);
