              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="card p-6">
                    <h2 className="heading-3 mb-4">Upload PDF Files</h2>
                ...
                <div className="space-y-6">
                  <div className="card p-6">
                    <h2 className="heading-3 mb-4">Merge PDFs</h2>
                  ...
                  {/* Info Panel */}
                  <div className="card p-6">
                    <h3 className="heading-4 mb-4">Merge Information</h3>
                    <div className="space-y-3 text-sm">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">Files to merge:</span>
