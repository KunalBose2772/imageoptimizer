  ...
  const categories = [
    {
      ...
      popularTools: [
        ...
        { name: 'HEIF to JPG', href: '/image-tools/heif-to-jpg', popular: true },
        { name: 'HEIC to WebP', href: '/image-tools/heic-to-webp', popular: true },
        { name: 'HEIF to PNG', href: '/image-tools/heif-to-png', popular: true },
        { name: 'PSD to JPG', href: '/image-tools/psd-to-jpg', popular: true },
      ],
      allTools: [
        { name: 'AVIF to JPG', href: '/image-tools/avif-to-jpg', popular: true },
        { name: 'AVIF to PNG', href: '/image-tools/avif-to-png', popular: true },
        ...
        { name: 'HEIF to PNG', href: '/image-tools/heif-to-png', popular: true },
        { name: 'PSD to JPG', href: '/image-tools/psd-to-jpg', popular: true },
        { name: 'PSD to PNG', href: '/image-tools/psd-to-png', popular: true },
        { name: 'PSD to WebP', href: '/image-tools/psd-to-webp', popular: true },
        { name: 'SVG to JPG', href: '/image-tools/svg-to-jpg', popular: true },
        { name: 'SVG to PNG', href: '/image-tools/svg-to-png', popular: true },
        { name: 'SVG to WebP', href: '/image-tools/svg-to-webp', popular: true },
        ...
        { name: 'ICO to JPG', href: '/image-tools/ico-to-jpg', popular: true },
        { name: 'ICO to WebP', href: '/image-tools/ico-to-webp', popular: true },
        { name: 'ICO to AVIF', href: '/image-tools/ico-to-avif', popular: true },
        ...
        { name: 'ICO to WebP', href: '/image-tools/ico-to-webp', popular: false },
        { name: 'ICO to AVIF', href: '/image-tools/ico-to-avif', popular: false },
