            ...
            <div className="px-4 py-4">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 gap-2 mb-4">
                  ...
                  <Link
                    href="/image-tools/ico-to-jpg"
                    className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <Image className="w-4 h-4 text-primary-500" />
                    <span className="text-sm font-medium text-gray-900 dark:text-white">ICO to JPG</span>
                  </Link>
                  <Link
                    href="/image-tools/ico-to-webp"
                    className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <Image className="w-4 h-4 text-primary-500" />
                    <span className="text-sm font-medium text-gray-900 dark:text-white">ICO to WebP</span>
                  </Link>
                  <Link
